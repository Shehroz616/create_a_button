...
const Sidebar = () => {
    ...
    return (
        <div className='flex items-stretch'>
            <div className="w-20 border-r border-gray-200 bg-gray-100 backdrop-blur-lg transition-all flex flex-col items-center py-3 px-1  space-y-4">
                ...
                <Button variant="ghost" 
                    ...
                    onClick={() => setActiveMenu(activeMenu === 'Uploads' ? null : 'Uploads')}>
            ...
            <div
                className={`border-r border-gray-200 bg-gray-100 backdrop-blur-lg transition-all duration-300 overflow-hidden ${activeMenu ? 'w-64' : 'w-0'
